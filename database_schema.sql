...
-- ==========================================
-- 5. TABLA: mapa_distribuidores
-- (Tabla independiente para la aplicación de mapa interactivo)
-- ==========================================
CREATE TABLE mapa_distribuidores (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    nombre TEXT NOT NULL,
...
-- Lectura pública: cualquier usuario (incluido anónimo) puede ver distribuidores activos
